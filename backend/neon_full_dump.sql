...
\restrict pDYGddoCdS6fPZmjxfG0JMe8AVnenWg3D9kr2gJGz5wkdHHc2tcWPGPtnhL8h8O
...
ALTER TABLE IF EXISTS ONLY public.tournament_teams DROP CONSTRAINT IF EXISTS tournament_teams_tournament_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_teams DROP CONSTRAINT IF EXISTS tournament_teams_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_records DROP CONSTRAINT IF EXISTS tournament_records_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_records DROP CONSTRAINT IF EXISTS tournament_records_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.records DROP CONSTRAINT IF EXISTS records_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.records DROP CONSTRAINT IF EXISTS records_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.players DROP CONSTRAINT IF EXISTS players_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.player_teams DROP CONSTRAINT IF EXISTS player_teams_tournament_id_fkey;
ALTER TABLE IF EXISTS ONLY public.player_teams DROP CONSTRAINT IF EXISTS player_teams_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.player_teams DROP CONSTRAINT IF EXISTS player_teams_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.player_career_stats DROP CONSTRAINT IF EXISTS player_career_stats_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.pitching_stats DROP CONSTRAINT IF EXISTS pitching_stats_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.pitching_stats DROP CONSTRAINT IF EXISTS pitching_stats_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.mlb_alumni DROP CONSTRAINT IF EXISTS mlb_alumni_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.hall_of_fame DROP CONSTRAINT IF EXISTS hall_of_fame_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.championships DROP CONSTRAINT IF EXISTS championships_runner_up_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.championships DROP CONSTRAINT IF EXISTS championships_mvp_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.championships DROP CONSTRAINT IF EXISTS championships_leading_pitcher_id_fkey;
ALTER TABLE IF EXISTS ONLY public.championships DROP CONSTRAINT IF EXISTS championships_champion_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.batting_stats DROP CONSTRAINT IF EXISTS batting_stats_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.batting_stats DROP CONSTRAINT IF EXISTS batting_stats_player_id_fkey;
ALTER TABLE IF EXISTS ONLY public.awards DROP CONSTRAINT IF EXISTS awards_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.awards DROP CONSTRAINT IF EXISTS awards_player_id_fkey;
DROP TRIGGER IF EXISTS update_teams_updated_at ON public.teams;
DROP INDEX IF EXISTS public.teams_name_uq;
DROP INDEX IF EXISTS public.players_first_last_uq;
DROP INDEX IF EXISTS public.pitching_stats_player_team_year_uq;
DROP INDEX IF EXISTS public.idx_tt_tournament;
DROP INDEX IF EXISTS public.idx_tt_team;
DROP INDEX IF EXISTS public.idx_tournaments_year;
DROP INDEX IF EXISTS public.idx_records_team;
DROP INDEX IF EXISTS public.idx_records_player;
DROP INDEX IF EXISTS public.idx_pt_tournament;
DROP INDEX IF EXISTS public.idx_player_teams_team;
DROP INDEX IF EXISTS public.idx_player_teams_player;
DROP INDEX IF EXISTS public.idx_champs_runnerup;
DROP INDEX IF EXISTS public.idx_champs_pitcher;
DROP INDEX IF EXISTS public.idx_champs_mvp;
DROP INDEX IF EXISTS public.idx_champs_champion;
DROP INDEX IF EXISTS public.idx_championships_year;
DROP INDEX IF EXISTS public.idx_awards_year;
DROP INDEX IF EXISTS public.idx_awards_player;
DROP INDEX IF EXISTS public.hall_of_fame_name_year_uq;
DROP INDEX IF EXISTS public.hall_of_fame_inductee_year_uq;
DROP INDEX IF EXISTS public.batting_stats_player_team_year_uq;
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS unique_team_triplet;
ALTER TABLE IF EXISTS ONLY public.tournaments DROP CONSTRAINT IF EXISTS tournaments_year_key;
ALTER TABLE IF EXISTS ONLY public.tournaments DROP CONSTRAINT IF EXISTS tournaments_pkey;
ALTER TABLE IF EXISTS ONLY public.tournament_teams DROP CONSTRAINT IF EXISTS tournament_teams_tournament_id_team_id_key;
ALTER TABLE IF EXISTS ONLY public.tournament_teams DROP CONSTRAINT IF EXISTS tournament_teams_pkey;
ALTER TABLE IF EXISTS ONLY public.tournament_records DROP CONSTRAINT IF EXISTS tournament_records_year_category_subcategory_record_type_key;
ALTER TABLE IF EXISTS ONLY public.tournament_records DROP CONSTRAINT IF EXISTS tournament_records_pkey;
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS teams_unique;
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS teams_pkey;
ALTER TABLE IF EXISTS ONLY public.single_game_records DROP CONSTRAINT IF EXISTS single_game_records_pkey;
...
ALTER TABLE IF EXISTS ONLY public.player_teams DROP CONSTRAINT IF EXISTS player_teams_pkey;
ALTER TABLE IF EXISTS ONLY public.player_career_stats DROP CONSTRAINT IF EXISTS player_career_stats_player_id_key;
ALTER TABLE IF EXISTS ONLY public.player_career_stats DROP CONSTRAINT IF EXISTS player_career_stats_pkey;
ALTER TABLE IF EXISTS ONLY public.pitching_stats DROP CONSTRAINT IF EXISTS pitching_stats_player_id_season_key_key;
ALTER TABLE IF EXISTS ONLY public.pitching_stats DROP CONSTRAINT IF EXISTS pitching_stats_pkey;
ALTER TABLE IF EXISTS ONLY public.mlb_alumni DROP CONSTRAINT IF EXISTS mlb_alumni_player_id_key;
ALTER TABLE IF EXISTS ONLY public.mlb_alumni DROP CONSTRAINT IF EXISTS mlb_alumni_pkey;
ALTER TABLE IF EXISTS ONLY public.hall_of_fame DROP CONSTRAINT IF EXISTS hof_unique;
ALTER TABLE IF EXISTS ONLY public.hall_of_fame DROP CONSTRAINT IF EXISTS hall_of_fame_pkey;
ALTER TABLE IF EXISTS ONLY public.championships DROP CONSTRAINT IF EXISTS championships_year_unique;
ALTER TABLE IF EXISTS ONLY public.championships DROP CONSTRAINT IF EXISTS championships_year_key;
ALTER TABLE IF EXISTS ONLY public.championships DROP CONSTRAINT IF EXISTS championships_pkey;
ALTER TABLE IF EXISTS ONLY public.batting_stats DROP CONSTRAINT IF EXISTS batting_stats_player_id_season_key_key;
ALTER TABLE IF EXISTS ONLY public.batting_stats DROP CONSTRAINT IF EXISTS batting_stats_pkey;
ALTER TABLE IF EXISTS ONLY public.awards DROP CONSTRAINT IF EXISTS awards_pkey;
ALTER TABLE IF EXISTS ONLY public.alltime_records DROP CONSTRAINT IF EXISTS alltime_records_pkey;
ALTER TABLE IF EXISTS ONLY public.alltime_records DROP CONSTRAINT IF EXISTS alltime_records_era_category_subcategory_record_type_key;
ALTER TABLE IF EXISTS public.tournament_records ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.single_game_records ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.player_career_stats ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pitching_stats ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.batting_stats ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.alltime_records ALTER COLUMN id DROP DEFAULT;
DROP VIEW IF EXISTS public.vw_pitching_expanded;
DROP VIEW IF EXISTS public.vw_championships;
DROP VIEW IF EXISTS public.vw_batting_expanded;
DROP TABLE IF EXISTS public.tournaments;
DROP TABLE IF EXISTS public.tournament_teams;
DROP SEQUENCE IF EXISTS public.tournament_records_id_seq;
DROP TABLE IF EXISTS public.tournament_records;
DROP TABLE IF EXISTS public.teams;
DROP SEQUENCE IF EXISTS public.single_game_records_id_seq;
DROP TABLE IF EXISTS public.single_game_records;
DROP TABLE IF EXISTS public.records;
DROP TABLE IF EXISTS public.players;
DROP TABLE IF EXISTS public.player_teams;
DROP SEQUENCE IF EXISTS public.player_career_stats_id_seq;
DROP TABLE IF EXISTS public.player_career_stats;
DROP SEQUENCE IF EXISTS public.pitching_stats_id_seq;
DROP TABLE IF EXISTS public.pitching_stats;
DROP TABLE IF EXISTS public.mlb_alumni;
DROP TABLE IF EXISTS public.hall_of_fame;
DROP TABLE IF EXISTS public.championships;
DROP SEQUENCE IF EXISTS public.batting_stats_id_seq;
DROP TABLE IF EXISTS public.batting_stats;
DROP TABLE IF EXISTS public.awards;
DROP SEQUENCE IF EXISTS public.alltime_records_id_seq;
DROP TABLE IF EXISTS public.alltime_records;
...
--
-- Name: alltime_records; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: alltime_records_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: alltime_records_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: hall_of_fame_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: mlb_alumni; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: mlb_alumni_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: single_game_records; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: single_game_records_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: single_game_records_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: tournament_records; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: tournament_records_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tournament_records_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: vw_batting_expanded; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: vw_championships; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: vw_pitching_expanded; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: alltime_records id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: single_game_records id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: tournament_records id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: alltime_records; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: batting_stats; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: hall_of_fame; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: mlb_alumni; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: pitching_stats; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: player_career_stats; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: single_game_records; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: tournament_records; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: alltime_records_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: batting_stats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: championships_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: hall_of_fame_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: mlb_alumni_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: pitching_stats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: single_game_records_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: tournament_records_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: alltime_records alltime_records_era_category_subcategory_record_type_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: alltime_records alltime_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: championships championships_year_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: championships championships_year_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hall_of_fame hof_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mlb_alumni mlb_alumni_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mlb_alumni mlb_alumni_player_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats player_career_stats_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats player_career_stats_player_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: single_game_records single_game_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: teams teams_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournament_records tournament_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournament_records tournament_records_year_category_subcategory_record_type_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournament_teams tournament_teams_tournament_id_team_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournaments tournaments_year_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: teams unique_team_triplet; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: hall_of_fame_inductee_year_uq; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: hall_of_fame_name_year_uq; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_awards_player; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_awards_year; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_championships_year; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_champs_champion; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_champs_mvp; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_champs_pitcher; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_champs_runnerup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_player_teams_player; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_player_teams_team; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pt_tournament; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_records_player; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_records_team; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tt_team; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tt_tournament; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: players_first_last_uq; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: teams_name_uq; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: awards awards_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: championships championships_champion_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: championships championships_leading_pitcher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: championships championships_mvp_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: championships championships_runner_up_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mlb_alumni mlb_alumni_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: player_career_stats player_career_stats_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: player_teams player_teams_tournament_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: records records_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournament_records tournament_records_player_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournament_records tournament_records_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict pDYGddoCdS6fPZmjxfG0JMe8AVnenWg3D9kr2gJGz5wkdHHc2tcWPGPtnhL8h8O
