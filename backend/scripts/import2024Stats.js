// backend/scripts/import2024Stats.js
...
async function import2024Stats() {
  const client = await pool.connect();

  try {
    console.log("🚀 Starting 2024 NBC World Series data import...\n");

    // Read JSON file
    const jsonPath = path.join(__dirname, "../data/nbc_2024_stats.json");
  ...
  INSERT INTO pitching_stats (
    ...
    console.log("\n" + "=".repeat(60));
    console.log("🎉 2024 IMPORT COMPLETE!");
