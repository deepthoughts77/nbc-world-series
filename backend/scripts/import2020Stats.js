// backend/scripts/import2020Stats.js
...
async function import2020Stats() {
  const client = await pool.connect();

  try {
    console.log("🚀 Starting 2020 NBC World Series data import...\n");

    // Read JSON file
    const jsonPath = path.join(__dirname, "../data/nbc_2020_stats.json");
  ...
  INSERT INTO pitching_stats (
    ...
    console.log("\n" + "=".repeat(60));
    console.log("🎉 2020 IMPORT COMPLETE!");
