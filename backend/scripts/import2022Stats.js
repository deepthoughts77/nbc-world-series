// backend/scripts/import2022Stats.js
...
async function import2022Stats() {
  const client = await pool.connect();

  try {
    console.log("🚀 Starting 2022 NBC World Series data import...\n");

    // Read JSON file
    const jsonPath = path.join(__dirname, "../data/nbc_2022_stats.json");
  ...
  INSERT INTO pitching_stats (
    ...
    console.log("\n" + "=".repeat(60));
    console.log("🎉 2022 IMPORT COMPLETE!");
