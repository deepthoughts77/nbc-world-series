...
async function import2025CompleteData() {
  ...
  try {
    ...
    // Create or get Jake Gutierrez (MVP)
    let mvpId = null;
    ...
    // ============================================
    // 4. ADD 2025 TOURNAMENT RECORDS
    // ============================================
    console.log("\n STEP 4: Recording 2025 Tournament Statistics...\n");

    // Note: We'll add a tournament_stats table for team/player records
    // For now, we'll document key achievements

    const records2025 = {
      team_batting: {
        most_sacrifice_flies: { team: "Lonestar Kraken TX", value: 7 },
        fewest_stolen_base_attempts: { team: "San Diego Stars", value: 0 },
        lowest_fielding_pct: { team: "Top Prospect Academy TX", value: 0.895 },
