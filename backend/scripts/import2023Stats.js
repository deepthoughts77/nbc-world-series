// backend/scripts/import2023Stats.js
...
async function import2023Stats() {
  const client = await pool.connect();

  try {
    console.log("🚀 Starting 2023 NBC World Series data import...\n");

    // Read JSON file
    const jsonPath = path.join(__dirname, "../data/nbc_2023_stats.json");
  ...
  INSERT INTO pitching_stats (
    ...
    console.log("\n" + "=".repeat(60));
    console.log("🎉 2023 IMPORT COMPLETE!");
