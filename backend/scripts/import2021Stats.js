// backend/scripts/import2021Stats.js
...
async function import2021Stats() {
  const client = await pool.connect();

  try {
    console.log("🚀 Starting 2021 NBC World Series data import...\n");

    // Read JSON file
    const jsonPath = path.join(__dirname, "../data/nbc_2021_stats.json");
  ...
  INSERT INTO pitching_stats (
    ...
    console.log("\n" + "=".repeat(60));
    console.log("🎉 2021 IMPORT COMPLETE!");
